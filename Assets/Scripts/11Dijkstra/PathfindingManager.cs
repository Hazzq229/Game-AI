...
{
    [Header("Pathfinding Manager Settings")]
    ...
    {
        Queue<Tile> path = pathfinding.FindPath(_startTile, _endTile);
        if (path == null)
    ...
    private void HandleInput()
    {
        ...
        {
            if (_agent == null)
                _agent = Instantiate(playerAgentPrefab, _startTile.transform.position, Quaternion.identity).GetComponent<Agent>();
            else
